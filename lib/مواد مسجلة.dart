       ...
       child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: TextButton(onPressed: (){}, child: Text('                    Material 1                  ',
              style: TextStyle(
                color: Colors.black,
                fontSize: 25,
              ),)
          ...
          Container(
            ...
            child: TextButton(onPressed: (){}, child: Text('                    Material 2                  ',
              style: TextStyle(
                color: Colors.black,
                fontSize: 25,
              ),)
          ...
          Container(
            ...
            child: TextButton(onPressed: (){}, child: Text('                    Material 3                  ',
              style: TextStyle(
                color: Colors.black,
                fontSize: 25,
              ),)
          ...
          Container(
            ...
            child: TextButton(onPressed: (){}, child: Text('                    Material 4                  ',
              style: TextStyle(
                color: Colors.black,
                fontSize: 25,
              ),)
